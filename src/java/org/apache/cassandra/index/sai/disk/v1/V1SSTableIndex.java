...
public class V1SSTableIndex extends SSTableIndex
{
                                         ...
                                         QueryContext context) throws IOException
    {
            ...
            || expression.getOp() == Expression.IndexOperator.NOT_CONTAINS_VALUE)
        {
            ...
            IndexDescriptor indexDesc = sstableContext.indexDescriptor;
            SSTableReader sstable = sstableContext.sstable;
            PrimaryKeyMap.Factory pkFactory = V1OnDiskFormat.instance.newPrimaryKeyMapFactory(indexDesc, sstable);
