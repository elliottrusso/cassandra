...
public class Expression
{
    ...
    {
        if (operator != IndexOperator.CONTAINS_KEY
            && operator != IndexOperator.CONTAINS_VALUE
            && operator != IndexOperator.NOT_CONTAINS_KEY
            && operator != IndexOperator.NOT_CONTAINS_VALUE)
            throw new UnsupportedOperationException("Only CONTAINS / NOT CONTAINS operators work on collections");
